            ...
            if ($_POST) {
                ...
                if (validateEmptyFields($validate_data)) {
                    if (empty(preg_matchall($validate_data_regex, regex_string)) && empty(preg_matchall($validate_data_regex_numbers, regex_numbers))) {
                        ...
                        // VALIDACIÓN DE CÉDULA REMOVIDA AQUÍ
                        ...
                        $data = array('status' => false, 'msg' => 'Algunos de tus campos están mal escritos, verifique y vuelva a ingresarlos');
                    }
                } else {
                    $data = array('status' => false, 'msg' => 'Algunos campos aún están vacíos, verifique y vuelva a ingresarlos');
                }
            } else {
